...
private Button dateButton,timeButton,btnback,btnbook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.textViewOD);
        ed1 = findViewById(R.id.editTextLTBPinCode);
        ed2 = findViewById(R.id.editTextLTBAppAddress);
        ed3 = findViewById(R.id.editTextLTBAppContact);
        ed4 = findViewById(R.id.editTextAppPassword2);
        dateButton = findViewById(R.id.buttonAppCartDate);
        timeButton = findViewById(R.id.buttonAppCartTime);
        btnback = findViewById(R.id.buttonAppBack);
        btnbook = findViewById(R.id.buttonBookApp2);
            ...
            public void onClick(View v) {
               Database db = new Database(getApplicationContext(), "healthcare", null, 1);
                ...
                String username = sharedPreferences.getString("username", "").toString();
                    ...
                    Toast.makeText(getApplicationContext(), "Appointment Already book", Toast.LENGTH_LONG).show();
                } else {
