...
public class CartBuyMedicineActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.buttonAppCartLTBBDate);
        TimeButton = findViewById(R.id.buttonAppCartLTBBTime);
        btnBack = findViewById(R.id.buttonCartLTBBBack);
        btnCheckout = findViewById(R.id.buttonCartLTBBCheckout);
        tvTotal = findViewById(R.id.textViewLTBBTotalCost);
        lst = findViewById(R.id.ListViewLTBB);
        ...
        for (int i = 0; i < dbData.size(); i++) {
            ...
            tvtotal = tvtotal+ Float.parseFloat(strData[1]);
        }
        tvTotal.setText("Total Cost:" + tvtotal);
